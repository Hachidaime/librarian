...
{block name='content'}
<div class="row mb-3">
  <div class="col-12">{include 'Templates/buttons/add.tpl'}</div>
</div>
        ...
        <table class="table table-bordered table-sm">
          <thead>
            <tr>
              ...
              <th class="align-middle text-center" width="20%">Username</th>
    ...
    $.post(
      ...
      (res) => {
        ...
        for (let index in list) {
          ...
          tRow = createElement({
            element: 'tr',
            children: [no, usrName, usrUsername, usrIsMaster, action],
          })
